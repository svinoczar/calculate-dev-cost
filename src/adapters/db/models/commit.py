...
class CommitModel(Base):
    ...
    is_conventional: Mapped[bool | None] = mapped_column(Boolean, nullable=True, default=False)
    conventional_type: Mapped[str | None] = mapped_column(Text, nullable=True)
    conventional_scope: Mapped[str | None] = mapped_column(Text, nullable=True)
    is_breaking_change: Mapped[bool | None] = mapped_column(Boolean, nullable=True, default=False)

    is_merge_commit: Mapped[bool | None] = mapped_column(Boolean, nullable=True, default=False)
    is_pr_commit: Mapped[bool | None] = mapped_column(Boolean, nullable=True, default=False)
    ...
    is_revert_commit: Mapped[bool | None] = mapped_column(Boolean, nullable=True, default=False)
